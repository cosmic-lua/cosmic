...
cosmic projects use Makefiles generated by `cosmic --make` to compile, type-check, format-check, and test code. see `cosmic --docs guide.make` for full details on Makefile generation.
