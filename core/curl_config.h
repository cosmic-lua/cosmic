 ...
 * (USE_MBEDTLS), the library core/crypto.c and M1 already build. No
 * zlib (no Content-Encoding decompression), no HTTP/2, no cookies.
 */
#ifndef COSMIC_CURL_CONFIG_H
#define COSMIC_CURL_CONFIG_H

#define PACKAGE "cosmic-curl"
#define PACKAGE_NAME "cosmic-curl"
#define PACKAGE_VERSION "8.22.0"
#define PACKAGE_STRING "cosmic-curl 8.22.0"
#define PACKAGE_TARNAME "cosmic-curl"
#define PACKAGE_BUGREPORT ""
#define VERSION "8.22.0"
...
#define CURL_WITH_MULTI_SSL 0
#define USE_IPV6 1
#define CURL_CA_BUNDLE_SET 1
...
#define CURL_DISABLE_PARSEDATE 0
