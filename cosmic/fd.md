...
```
 ...
 Lets a raw fd from any source enter the Handle world:
 h:read()/h:write()/h:close(), plus automatic cleanup via the
 __close metamethod. The Handle takes ownership: closing it
 closes the fd.
