...
| D47 | an item's spec declares intent only; measurement and outcome live in its own history | amended 2026-09 (the one cutover became the reader's view, pushed in batches — D49) | [→](d47-spec-declares-intent-only.md) |
