...
| D37 | the board holds two states; quality is two gates, not stages | amended 2026-08 | [→](d37-two-states-two-gates.md) |
...
| D43 | docs are four kinds by reader need, in plain sentences, with code that is checked | active | [→](d43-docs-are-four-kinds-with-checked-code.md) |
