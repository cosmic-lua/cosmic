...
- **date:** 2026-09
- **status:** amended 2026-09 (the one cutover became the reader's view, pushed in batches — D49)
...
- **amended 2026-09 (the one cutover became the reader's view, pushed
  in batches — [D49](d49-board-rewrite-pushes-in-idempotent-batches.md)):**
  ...
  egress proxy, so the rewrite went in 31 atomic batches with the
